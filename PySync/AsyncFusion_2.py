...
class AsyncFuse(object, metaclass=Async_Meta):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.process_executor = ProcessPoolExecutor(*self.fuseargs,**self.fusekwargs)
        self.thread_executor = ThreadPoolExecutor(*self.fuseargs,**self.fusekwargs)
    ...
    def __call__(self, *args, **kwargs):
        ...
        if inspect.iscoroutinefunction(self.func):
            ...
            if self.cpu_bound:
                ...
                self.rate_limiter.get_token()
                future = self.thread_executor.submit(self.func, *args, **kwargs)
